    ...
    <div className="min-h-screen bg-zinc-950 text-zinc-100">
      <header className="sticky top-0 z-10 border-b border-zinc-800 bg-zinc-950/95 backdrop-blur">
        <div className="mx-auto max-w-6xl px-4 py-4">
          ...
          <h1 className="mt-2 text-2xl font-bold tracking-tight text-white">Marketplace — Packages</h1>
          <p className="mt-1 text-sm text-zinc-400">
            Health packages, tour experiences, and combo offers in Medellín and Manizales.
          </p>
        </div>
      </header>
      ...
      <main className="mx-auto max-w-6xl px-4 py-8">
        ...
        {packages.length === 0 ? (
          <p className="rounded-xl border border-zinc-800 bg-zinc-900/50 p-8 text-center text-zinc-400">
            No packages match your filters. Try adjusting city, type, or price.
          </p>
        ) : (
