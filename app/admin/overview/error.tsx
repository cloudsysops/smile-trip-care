...
export default function AdminOverviewError({ error, reset }: Props) {
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-50">
      <main className="mx-auto flex max-w-xl flex-col items-center justify-center px-4 py-14 text-center">
        <h1 className="text-xl font-semibold">Something went wrong</h1>
        <p className="mt-2 text-sm text-zinc-300">We couldn&apos;t load the admin overview.</p>
        ...
        <div className="mt-6 flex flex-wrap items-center justify-center gap-3">
          ...
          <Link
            href="/admin/login?next=/admin/overview"
