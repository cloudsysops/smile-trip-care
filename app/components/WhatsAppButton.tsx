...
export function WhatsAppButton({
  ...
  if (isFloat) {
    return (
      <a
        ...
        aria-label={label}
        className={
          "fixed bottom-6 right-6 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg transition hover:scale-105 hover:shadow-xl " +
          className
        }
      >
  ...
  return (
    <a
      ...
      rel="noopener noreferrer"
      className={
        "inline-flex items-center gap-2 rounded-full border border-[#25D366] bg-[#25D366] px-5 py-2.5 text-sm font-medium text-white hover:opacity-90 " +
        className
      }
    >
