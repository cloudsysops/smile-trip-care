    ...
    <section className="rounded-2xl border border-zinc-800 bg-zinc-900/80 p-8 md:p-10">
      ...
      <div className="prose prose-invert max-w-none text-zinc-400">
        {mainCopy ? (
          ...
          <>
            <p className="leading-relaxed">
              {name} is part of the Smile Transformation curated network of trusted specialists. Our partners are selected for their experience, professional standards, and focus on international patients seeking quality oral health and dental care in Colombia.
            </p>
        ...
        <p className="mt-6 text-sm text-zinc-500">
          This profile is part of a curated network—not an open marketplace. Smile Transformation connects you with vetted specialists and coordinates your experience from evaluation through recovery.
        </p>
      </div>
    </section>
  );
