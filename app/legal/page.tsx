    ...
    <div className="min-h-screen bg-zinc-950 text-zinc-100">
      ...
      <main className="mx-auto max-w-3xl px-4 py-12">
        ...
        <p className="mb-4 text-zinc-400">
          MedVoyage Smile is a USA LLC. We coordinate international health and hospitality only; medical services are provided and billed by clinics in Colombia.
        </p>
