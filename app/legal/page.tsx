...
export const metadata = {
  title: `Legal | ${branding.productName}`,
    ...
    <div className="min-h-screen bg-zinc-950 text-zinc-100">
      <header className="border-b border-zinc-800 bg-zinc-950">
        <div className="mx-auto flex max-w-3xl items-center justify-between px-4 py-4">
          <Link href="/" className="text-lg font-semibold text-white hover:text-zinc-300">{branding.productName}</Link>
      ...
      <main className="mx-auto max-w-3xl px-4 py-12">
        ...
        <p className="mb-4 text-zinc-400">
          {branding.productName} is a USA LLC. We coordinate international health and hospitality only; medical services are provided and billed by clinics in Colombia.
        </p>
