...
- `supabase/migrations/0009_payment_reliability.sql`: adds Stripe webhook events ledger, enforces checkout-session uniqueness in payments, and prepares reconciliation-safe payment handling.
